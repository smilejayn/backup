...
for (var compIndex = 1; compIndex <= app.project.numItems; compIndex++) {
    ...
    if (item instanceof CompItem) {
        ...
        for (var layerIndex = 1; layerIndex <= comp.numLayers; layerIndex++) {
            ...
            else if (!wasLocked && layer instanceof ShapeLayer) {
                // Skip renaming shape layers
                continue;
            } 
            else if (!wasLocked && (layer.source && layer.source.mainSource instanceof SolidSource)) {
                // Skip renaming solid layers
                continue;
            }
