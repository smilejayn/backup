...
g = win.graphics;
  var myBrush = g.newBrush(g.BrushType.SOLID_COLOR, [0, 0, 0]);
...
win.g15.et2.text = "1080";  // Default height value
...
win.g15.et1.enabled=true;  // Text box for width is enabled by default
win.g15.et2.enabled=true;  // Text box for height is enabled by default
...
win.g35.cb1.value = true;  // Checkbox is checked by default
...
win.g40.bu1.enabled = false;  // Button is disabled by default
...
win.g260.cb3.value = true; // Checkbox is checked by default
win.g260.dd2 = win.g260.add('dropdownlist')
for(var a = 0;a<101;a++){
    win.g260.dd2.add('item',a);
    }
win.g260.dd2.selection=100;
